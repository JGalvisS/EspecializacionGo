...
func main() {
	//NOTA: .env NUNCA va al repositorio, debe ser ignorado con .gitignore lo dejo en este repo con el fin de ver como funciona
	err :=godotenv.Load("../../.env")
	if err != nil {
		log.Fatal("No carga las varianles de entorno", err)
	}
